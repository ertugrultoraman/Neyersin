...
export const sozluk: Record<string, Record<Dil, string>> = {
  ...
  /* Profili kişiselleştiren alanlar — bkz. components/hesap/ProfilFormu */
  "profil.deneyim": { tr: "Kaç yıldır pişiriyorsun?", en: "How long have you been cooking?" },
  "profil.deneyimIpucu": {
    tr: "Sadece sayı yaz. Profilinde “32 yıldır pişiriyor” diye görünür.",
    en: "Just the number. It shows as “cooking for 32 years” on your profile.",
  },
  "profil.memleket": { tr: "Mutfağın nereli?", en: "Where is your cooking from?" },
  "profil.memleketIpucu": {
    tr: "Yemeğin geldiği yer, müşterinin en çok merak ettiği şey.",
    en: "Where the food comes from is what customers wonder about most.",
  },
  "profil.memleketYer": { tr: "Örn. Erzurum mutfağı", en: "e.g. Erzurum cuisine" },
  "profil.imzaYemegi": { tr: "İmza yemeğin", en: "Your signature dish" },
  "profil.imzaYemegiIpucu": {
    tr: "En çok bilindiğin tek yemek — profilinin en üstünde rozet gibi durur.",
    en: "The one dish you're known for — it sits at the top of your profile.",
  },
  "profil.imzaYemegiYer": { tr: "Örn. Fırın mantı", en: "e.g. Baked mantı" },
  "profil.pisiriyor": { tr: "{yil} yıldır pişiriyor", en: "cooking for {yil} years" },
  "profil.imzaEtiketi": { tr: "İmza yemeği", en: "Signature dish" },
  "profil.mutfagindan": { tr: "Mutfağından", en: "From the kitchen" },
  "profil.kareEkle": { tr: "Mutfağından bir kare ekle", en: "Add a photo from your kitchen" },
  "profil.kareKaldir": { tr: "Kaldır", en: "Remove" },
  "profil.kareAciklama": {
    tr: "Tencerenin başı, taze hamur, tezgâh… Müşteri yemeğin nerede piştiğini görüyor. En fazla {adet} kare.",
    en: "The pot on the stove, fresh dough, the worktop… Customers see where the food is cooked. Up to {adet} photos.",
  },
  "profil.kareDolu": {
    tr: "{adet} karenin hepsi dolu. Yenisi için önce birini kaldır.",
    en: "All {adet} photos are in use. Remove one to add another.",
  },
  "profil.kareYukleniyor": { tr: "Yükleniyor…", en: "Uploading…" },
  "profil.kareEklendi": { tr: "Kare eklendi.", en: "Photo added." },
  "profil.kareKaldirildi": { tr: "Kare kaldırıldı.", en: "Photo removed." },
  "profil.kareSinir": {
    tr: "En fazla {adet} kare ekleyebilirsin. Önce birini kaldır.",
    en: "You can add at most {adet} photos. Remove one first.",
  },
  "profil.kareSecilmedi": { tr: "Kaldırılacak kare belirtilmedi.", en: "No photo was given to remove." },
  "profil.eksikFotograf": { tr: "Profil fotoğrafın", en: "Your profile photo" },
  "profil.eksikDeneyim": { tr: "Kaç yıldır pişirdiğin", en: "How long you have been cooking" },
  "profil.eksikMemleket": { tr: "Mutfağının nereli olduğu", en: "Where your cooking is from" },
  "profil.eksikImza": { tr: "İmza yemeğin", en: "Your signature dish" },
  "profil.eksikBiyografi": { tr: "Kendi hikâyen", en: "Your own story" },
  "profil.eksikGaleri": { tr: "Mutfağından kareler", en: "Photos from your kitchen" },
  "profil.fotografBaglantisi": {
    tr: "Fotoğrafı hesabımdan ekleyebilirsin →",
    en: "You can add the photo from My account →",
  },
  "profil.tamamlama": { tr: "Profilini tamamla", en: "Complete your profile" },
  "profil.tamamlamaAciklama": {
    tr: "Dolu bir profil, müşterinin siparişi verirken en çok baktığı yer. Eksikler:",
    en: "A complete profile is what customers look at most before ordering. Missing:",
  },
  "profil.tamamlandi": {
    tr: "Profilin tamam. Müşteri seni tanıyarak sipariş veriyor.",
    en: "Your profile is complete. Customers order knowing who you are.",
  },
  ...
  "panel.rolIsletme": { tr: "İşletme paneli", en: "Business dashboard" },
  "isletme.ozet": {
  ...
  "isletme.tahtaAciklama": {
    ...
    en: "Orders in progress, by stage. Completed ones are on the My Orders screen.",
  },
  "isletme.sutunYeni": { tr: "Yeni · hazırlanacak", en: "New · to prepare" },
  "isletme.sutunHazir": { tr: "Hazır · kurye bekliyor", en: "Ready · waiting for courier" },
  "isletme.sutunYolda": { tr: "Yolda", en: "On the way" },
  "isletme.sutunBos": { tr: "Bu aşamada sipariş yok.", en: "No orders at this stage." },
  ...
  "hesabim.rolIsletme": { tr: "İşletme hesabı", en: "Business account" },
  ...
  "fotograf.baslik": { tr: "Profil fotoğrafı", en: "Profile photo" },
  "fotograf.dosyaSec": { tr: "Profil fotoğrafı seç", en: "Choose a profile photo" },
  "fotograf.kural": { tr: "Kare fotoğraf en iyi görünür. JPG, PNG, WebP veya AVIF; en fazla 4 MB.", en: "A square photo looks best. JPG, PNG, WebP or AVIF; 4 MB max." },
  "fotograf.yukle": { tr: "Yükle", en: "Upload" },
  "fotograf.degistir": { tr: "Değiştir", en: "Replace" },
  "fotograf.yukleniyor": { tr: "Yükleniyor…", en: "Uploading…" },
  "fotograf.kaldir": { tr: "Fotoğrafı kaldır", en: "Remove photo" },
  "fotograf.sec": { tr: "Bir fotoğraf seç.", en: "Choose a photo." },
  "fotograf.tur": { tr: "JPG, PNG, WebP veya AVIF olmalı.", en: "It must be JPG, PNG, WebP or AVIF." },
  "fotograf.buyuk": { tr: "Fotoğraf en fazla 4 MB olabilir.", en: "The photo can be 4 MB at most." },
  "fotograf.depoYok": { tr: "Görsel deposu yapılandırılmadı.", en: "Image storage is not configured." },
  "fotograf.hesapYok": { tr: "Hesap bulunamadı.", en: "Account not found." },
  "fotograf.oturumYok": { tr: "Oturum bulunamadı.", en: "No active session." },
  "fotograf.yuklenemedi": { tr: "Fotoğraf yüklenemedi, tekrar dene.", en: "The photo could not be uploaded, try again." },
  "fotograf.kaydedildi": { tr: "Fotoğraf kaydedildi.", en: "Photo saved." },
  "fotograf.kaldirilamadi": { tr: "Kaldırılamadı, tekrar dene.", en: "It could not be removed, try again." },
  "fotograf.kaldirildi": { tr: "Fotoğraf kaldırıldı.", en: "Photo removed." },
  ...
  "siparis.kuryeCiroAlt": { tr: "Teslim ettiğin siparişlerin tutarı", en: "Value of the orders you delivered" },
  "siparis.kuryeToplamHakedis": { tr: "Toplam hakediş", en: "Total earnings" },
  "siparis.kuryeHakedisAlt": { tr: "Senin payın — tahsilat dahil değil", en: "Your share — cash collected not included" },
